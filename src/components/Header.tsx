    ...
    return (
        <header style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                <span style={{ fontSize: "10px", color: "rgba(255,255,255,0.4)", fontWeight: 600, background: "rgba(255,255,255,0.1)", padding: "2px 6px", borderRadius: "10px" }}>v1.28</span>
            </div>
            ...
            <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                ...
                <div style={{ display: "flex", gap: "4px", background: "rgba(255,255,255,0.05)", borderRadius: "10px", padding: "4px" }}>
                    {(Object.entries(MODE_LABELS) as [("casual" | "structured"), string][]).map(([m, label]) => (
                ...
                >
                    <span>⚙️</span>
                    {!apiKeys[aiProvider as keyof APIKeys] && aiProvider !== "claude" && (
