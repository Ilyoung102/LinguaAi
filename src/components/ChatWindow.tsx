                        ...
                        <div style={{ maxWidth: "70%", position: "relative" }}>
                            ...
                            {msg.isScenario ? (
                                <div style={{
                                    ...
                                    gap: "8px",
                                    padding: "10px 16px",
                                    background: `rgba(${hexToRgb(msg.scenarioColor || "#000")}, 0.15)`,
                                    border: `1px solid rgba(${hexToRgb(msg.scenarioColor || "#000")}, 0.4)`,
                                    borderRadius: "18px 18px 4px 18px",
                                    boxShadow: `0 2px 12px rgba(${hexToRgb(msg.scenarioColor || "#000")}, 0.2)`,
                                }}>
